...
const gameData: Record<string, {
  ...
  "guess-the-ai": {
    ...
    longDescription: "Test your wits against advanced AI opponents in this mind-bending puzzle game. Can you distinguish between human and AI-generated content? Rise through the ranks and prove your cognitive superiority on the blockchain.",
    ...
    screenshots: [
      "https://kult-store-assets.sfo3.cdn.digitaloceanspaces.com/Home_Carousel/Desktop/Guess_the_ai.png",
    ],
  },
  "zero-g-pool": {
    title: "Zero G Pool",
    ...
    screenshots: [
      "https://kult-store-assets.sfo3.cdn.digitaloceanspaces.com/Home_Carousel/Desktop/Zero_Z_Pool.png",
    ],
  },
  "zero-dash": {
    title: "Zero Dash",
    ...
    screenshots: [
      "https://kult-store-assets.sfo3.cdn.digitaloceanspaces.com/Home_Carousel/Desktop/Zero%20dash%20Carousel%20Desk.png",
    ],
  },
  "robo-wars": {
    title: "Robo Wars",
    ...
    screenshots: [
      "https://kult-store-assets.sfo3.cdn.digitaloceanspaces.com/Home_Carousel/Desktop/Robo_wars.png",
    ],
  },
  "highway-hustle": {
    ...
    screenshots: [
      "https://kult-store-assets.sfo3.cdn.digitaloceanspaces.com/Home_Carousel/Desktop/Highway_Hustle.png",
    ],
  },
  "warzone-warriors": {
    title: "Warzone Warriors",
    description: "Epic battles in a decentralized warzone.",
    longDescription: "Enter the ultimate battlefield where strategy meets skill. Command your warriors, conquer territories, and earn exclusive rewards in this on-chain strategy combat game.",
    image: "https://kult-store-assets.sfo3.cdn.digitaloceanspaces.com/Home_Carousel/Desktop/Guess_the_ai.png",
    category: "BATTLE",
    rating: 4.9,
    ...
    features: ["Territory Conquest", "Clan Wars", "Strategic Combat", "Exclusive NFTs"],
    screenshots: [
      "https://kult-store-assets.sfo3.cdn.digitaloceanspaces.com/Home_Carousel/Desktop/Guess_the_ai.png",
    ],
  },
      ...
      <section className="relative pt-24 pb-20 z-10">
        ...
        <div className="relative h-[400px] overflow-hidden">
          ...
          <motion.button
            ...
            onClick={() => navigate(-1)}
            className="absolute top-6 left-6 flex items-center gap-2 px-4 py-2 rounded-lg glass-panel text-sm text-foreground hover:text-primary transition-colors"
          >
          ...
          <div className="flex flex-col lg:flex-row gap-10">
            ...
            <div className="flex-1">
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
                ...
                <h1 className="font-display text-4xl md:text-5xl font-black text-foreground tracking-tight mt-2">
                  {game.title}
                </h1>
