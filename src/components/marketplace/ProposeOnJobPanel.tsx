    ...
    <section className="rounded-lg border border-white/10 bg-black/30 p-4">
      ...
      {candidates.length > 1 ? (
        <select
          ...
          className="mt-3 w-full rounded border border-white/10 bg-black/40 px-3 py-2 text-sm text-white focus:border-cyan-500/50 focus:outline-none"
        >
          {candidates.map((a) => (
      ...
      <button
        ...
        className="mt-3 flex items-center gap-1.5 rounded border border-cyan-500/40 bg-cyan-500/10 px-4 py-2 font-tech text-[10px] font-bold uppercase tracking-wider text-cyan-300 transition hover:bg-cyan-500/20 disabled:cursor-not-allowed disabled:opacity-40"
      >
