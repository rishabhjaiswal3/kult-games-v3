  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{
          background: "linear-gradient(135deg, hsl(270 70% 55% / 0) 0%, hsl(270 70% 55% / 0.05) 50%, hsl(270 70% 55% / 0) 100%)",
      ...
      <div className="relative aspect-[4/3] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="w-14 h-14 rounded-full bg-card/80 backdrop-blur-sm flex items-center justify-center border border-border/50 group-hover:bg-primary/20 group-hover:border-primary/50 group-hover:shadow-[0_0_20px_hsl(270_70%_55%/0.3)] transition-all duration-300">
