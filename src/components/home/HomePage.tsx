...
import worldCupLeagueTrophy from "@/assets/home/world-cup-league-trophy.webp";
import homeLeagueBkg from "@/assets/home-league-bkg.webp";
...
function homeHeroCtaGridClass(count: number) {
  if (count <= 2) {
    return "grid w-full max-w-full grid-cols-2 gap-1.5 sm:max-w-[300px] md:grid-cols-1 md:max-w-[220px] md:gap-1.5 lg:grid-cols-1 lg:max-w-[220px] lg:gap-1.5 xl:max-w-[240px]";
  }
  return "grid w-full max-w-full grid-cols-2 gap-1.5 sm:max-w-[300px] md:grid-cols-1 md:max-w-[220px] md:gap-1.5 lg:grid-cols-1 lg:max-w-[220px] lg:gap-1.5 xl:max-w-[240px]";
}
        ...
        >
          {visibleStatTiles.map((stat, index) => (
            <Link
              key={stat.label}
              to={stat.path}
              className={`home-stat-tile relative z-10 flex min-w-0 items-center gap-2.5 px-3 py-3.5 sm:gap-3 sm:px-4 sm:py-4 lg:gap-4 lg:px-6 lg:py-4 ${
                visibleStatTiles.length === 3
                  ? index === 1
            ...
            >
              <div
                className="home-stat-icon grid h-9 w-9 shrink-0 place-items-center rounded-lg sm:h-10 sm:w-10 lg:h-11 lg:w-11"
              >
