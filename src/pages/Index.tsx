                ...
                <div className="grid items-center gap-8 md:grid-cols-2 md:gap-12">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-3">
                      <button
                        onClick={() => navigate("/ai-arena")}
                        className="group inline-flex items-center gap-2.5 px-8 py-3.5 font-display text-sm font-bold tracking-wider btn-eye relative overflow-hidden"
                      >
