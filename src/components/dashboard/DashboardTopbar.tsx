            ...
            {isAuthenticated ? (
              <>
                ...
                <button
                  ...
                  className="inline-flex h-8 shrink-0 items-center justify-center gap-1 rounded-full border border-red-400/18 bg-red-500/[0.06] px-2.5 font-tech text-[13px] font-bold uppercase tracking-[0.12em] text-red-300/85 transition-all hover:border-red-300/38 hover:bg-red-500/12 hover:text-red-200 min-[430px]:px-3"
                >
