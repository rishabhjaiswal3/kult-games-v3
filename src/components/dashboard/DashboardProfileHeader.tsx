      ...
      <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <h1 className="mt-0.5 font-tech text-2xl font-bold uppercase tracking-tight text-white sm:text-3xl">
              {displayName}
            </h1>
            <p className="mt-1 text-sm text-white/55">Your command center — agents, battles, and arena progress.</p>
            {walletAddress ? (
              <button
                type="button"
                onClick={copyWallet}
                className="mt-2 inline-flex items-center gap-1.5 font-tech text-[10px] uppercase tracking-wider text-white/45 transition hover:text-[#c78aff]"
              >
