...
export function WarzoneWarriorsDetail({ game }: { game: Game }) {
  ...
  return (
    <div className="mx-auto w-full max-w-[1320px] pb-20 text-[#8d8d91] [&_p]:text-justify">
      ...
      <section className="relative overflow-hidden border border-[#008cff] bg-[#050b14]">
      ...
      <section className="mt-14 grid items-end gap-8 lg:grid-cols-[minmax(0,1fr)_540px]">
        ...
        <div className="rounded-[13px] border border-[#24103e] bg-[#09051c] p-5">
          <div className="mb-5 flex items-center justify-between">
            <h2 className="font-tech text-xl font-bold uppercase text-white sm:text-2xl">Launch Control</h2>
            <span className="rounded-md bg-white/10 px-5 py-1 text-white/35">v1.0</span>
          </div>
          <button type="button" onClick={play} className="flex w-full items-center justify-center gap-2 rounded-md bg-gradient-to-r from-[#681fd0] to-[#973af4] py-3 text-xl font-semibold text-white transition hover:brightness-110">
            <Play className="h-6 w-6" /> Play
          </button>
          <button type="button" onClick={() => navigate("/inventory")} className="mt-4 flex w-full items-center justify-center gap-2 rounded-md border border-[#25103d] bg-[#070214] py-3 text-xl font-semibold text-white transition hover:border-purple-600">
            <BriefcaseBusiness className="h-6 w-6" /> Inventory
          </button>
        </div>
      </section>
      ...
      <section className="mt-8 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
        {[
          ...
          <button key={item.label} type="button" onClick={item.action} disabled={!item.action} className="flex items-center gap-4 rounded-[5px] border border-[#16132d] bg-[#080719] p-3 text-left disabled:cursor-default">
      ...
      <main className="mt-14 max-w-[920px] space-y-16 text-[17px] leading-[1.65] text-[#a5a5ad] [&_strong]:font-semibold [&_strong]:text-white/80 [&_li]:pl-1">
        ...
        <aside className="overflow-hidden rounded-[16px] border border-[#362052] bg-gradient-to-b from-[#0b1020] to-[#050a13] shadow-[0_20px_70px_rgba(0,0,0,0.35)] lg:sticky lg:top-24 [&_p]:!text-left">
          <div className="border-b border-white/5 bg-[radial-gradient(circle_at_50%_0%,rgba(145,50,255,0.18),transparent_68%)] px-5 pb-5 pt-6 text-center">
          ...
          <div className="p-5">
            ...
            <button type="button" onClick={play} className="mt-5 flex w-full items-center justify-center gap-2 rounded-md bg-gradient-to-r from-[#681fd0] to-[#973af4] py-3 font-semibold text-white transition hover:brightness-110 active:translate-y-0">
              <Play className="h-4 w-4" /> Play now
            </button>
            <button type="button" onClick={share} className="mt-3 flex w-full items-center justify-center gap-2 rounded-md border border-[#24405e] bg-[#071426] py-2.5 text-sm text-white transition-colors hover:border-purple-500/60 active:translate-y-0">
