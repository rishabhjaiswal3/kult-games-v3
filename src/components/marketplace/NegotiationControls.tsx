        ...
        {alreadySigned ? (
          ...
          <>
            <button
              ...
              onClick={() => sign.mutate()}
              disabled={busy}
              className="flex items-center gap-1.5 rounded border border-emerald-500/40 bg-emerald-500/10 px-3 py-2 font-tech text-[10px] font-bold uppercase tracking-wider text-emerald-300 transition hover:bg-emerald-500/20 disabled:opacity-40"
            >
              {sign.isPending ? (
    ...
    <div className="mt-3 space-y-2 border-t border-white/10 pt-3">
      <div className="flex items-end gap-2">
        ...
        <button
          ...
          className="flex items-center gap-1.5 rounded border border-cyan-500/40 bg-cyan-500/10 px-3 py-2 font-tech text-[10px] font-bold uppercase tracking-wider text-cyan-300 transition hover:bg-cyan-500/20 disabled:cursor-not-allowed disabled:opacity-40"
        >
          {offer.isPending ? (
            <Loader2 className="h-3 w-3 animate-spin" />
          ) : (
      ...
      {onTable ? (
        <div className="flex gap-2">
          <button
            ...
            disabled={busy}
            className="flex flex-1 items-center justify-center gap-1.5 rounded border border-emerald-500/40 bg-emerald-500/10 px-3 py-2 font-tech text-[10px] font-bold uppercase tracking-wider text-emerald-300 transition hover:bg-emerald-500/20 disabled:opacity-40"
          >
            <Check className="h-3 w-3" />
