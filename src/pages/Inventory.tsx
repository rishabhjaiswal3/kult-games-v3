  ...
  return (
    <ArenaPageLayout contentClassName="max-w-none">
      <div className="inventory-hero sticky top-0 z-40 -mx-4 border-b border-white/8 px-4 py-3 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
        <div className="relative overflow-hidden rounded-lg border border-white/6 bg-[#04080f]/95 p-3 sm:p-3.5">
          <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_20%_0%,rgba(154,53,255,0.12),transparent_55%)]" />
          <div className="relative flex flex-col gap-2.5 lg:flex-row lg:items-stretch lg:gap-3">
            <div className="min-w-0 shrink-0 lg:max-w-[42%] xl:max-w-[38%]">
              <h1 className="font-tech text-2xl font-bold uppercase tracking-tight text-white sm:text-3xl">
                Inventory
              </h1>
