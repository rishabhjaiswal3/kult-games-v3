...
const GamesSection = () => {
  ...
  return (
    <section className="relative py-20 z-10 overflow-hidden">
      ...
      <div className="absolute bottom-20 right-0 w-[350px] h-[350px] rounded-full bg-neon-purple/5 blur-[120px] pointer-events-none" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full bg-neon-cyan/3 blur-[180px] pointer-events-none" />
